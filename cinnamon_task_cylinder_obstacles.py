...
class QuadrupedReachEnv(BaseEnv):
    ...
    def build_cylinder(
        ...
        return self._build_object_by_type(builder, name, body_type, scene_idxs, initial_pose)
    ...
    def _load_scene(self, options: dict):
        ...
        self.cube_1 = self.build_cylinder(
            self.scene,
            radius=QuadrupedReachEnv.CUBE_HALF_SIZE,
            half_length=QuadrupedReachEnv.CUBE_HEIGHT,
            color=[1, 0, 0, 1],
        ...
        self.cube_2 = self.build_cylinder(
            self.scene,
            radius=QuadrupedReachEnv.CUBE_HALF_SIZE,
            half_length=QuadrupedReachEnv.CUBE_HEIGHT,
            color=[1, 0, 0, 1],
            name="obstacle_cylinder_2",
            add_collision=True,
            body_type="kinematic"
        )

        self.cube_3 = self.build_cylinder(
            self.scene,
            radius=QuadrupedReachEnv.CUBE_HALF_SIZE,
            half_length=QuadrupedReachEnv.CUBE_HEIGHT,
            color=[1, 0, 0, 1],
            name="obstacle_cylinder_3",
            add_collision=True,
            body_type="kinematic"
        )
